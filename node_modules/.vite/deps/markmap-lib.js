      ...
      return (
        ...
        function() {
          ...
          function defineFunction(_ref) {
            var type2 = _ref.type, names = _ref.names, props = _ref.props, handler = _ref.handler, htmlBuilder2 = _ref.htmlBuilder, mathmlBuilder2 = _ref.mathmlBuilder;
            var data = {
              type: type2,
          ...
          function defineFunctionBuilders(_ref2) {
            var type2 = _ref2.type, htmlBuilder2 = _ref2.htmlBuilder, mathmlBuilder2 = _ref2.mathmlBuilder;
            defineFunction({
              type: type2,
              names: [],
              props: {
          ...
          var MathNode = function() {
            function MathNode2(type2, children, classes) {
              this.type = void 0;
              this.attributes = void 0;
              this.children = void 0;
              this.classes = void 0;
          ...
          var makeText = function makeText2(text2, mode, options) {
            if (src_symbols[mode][text2] && src_symbols[mode][text2].replace && text2.charCodeAt(0) !== 55349 && !(ligatures.hasOwnProperty(text2) && options && (options.fontFamily && options.fontFamily.substr(4, 2) === "tt" || options.font && options.font.substr(4, 2) === "tt"))) {
          ...
          var Namespace = function() {
            ...
            _proto.has = function has2(name2) {
            ...
            _proto.set = function set2(name2, value, global2) {
              if (global2 === void 0) {
                global2 = false;
              }
              if (global2) {
              ...
              var midMacro = function midMacro2(double) {
                return function(context2) {
                  ...
                  if (!double && middleDouble.length) {
                    var nextToken2 = context2.future();
                    if (nextToken2.text === "|") {
                      context2.popToken();
                      doubled = true;
                    }
          ...
          var Parser = function() {
            ...
            _proto.parseAtom = function parseAtom(breakOnTokenText) {
              ...
              while (true) {
                ...
                if (lex.text === "\\limits" || lex.text === "\\nolimits") {
                  ...
                  var str2 = uSubsAndSups[lex.text];
                  ...
                  while (true) {
                    ...
                    this.consume();
                    str2 += uSubsAndSups[token];
                  }
                  var body = new Parser2(str2, this.settings).parse();
                  if (isSub) {
                    subscript = {
                      type: "ordgroup",
                      mode: "math",
            ...
            _proto.parseGroupOfType = function parseGroupOfType(name2, type2, optional) {
              switch (type2) {
                case "color":
...
var require_remarkable_katex = __commonJS({
  "node_modules/remarkable-katex/index.js"(exports, module) {
    ...
    var rkatex = (md, options) => {
      ...
      const katex2 = require_katex();
      const renderKatex = (source, displayMode) => katex2.renderToString(
        source,
        {
          displayMode,
          throwOnError: false
...
// node_modules/markmap-common/dist/index.esm.js
var Hook = class {
  constructor() {
    this.listeners = [];
  }
...
rules.code = function(tokens, idx) {
  if (tokens[idx].block) {
    return "<pre><code>" + escapeHtml2(tokens[idx].content) + "</code></pre>" + getBreak(tokens, idx);
  }
  return "<code>" + escapeHtml2(tokens[idx].content) + "</code>";
};
rules.fence = function(tokens, idx, options, env, instance) {
  ...
  if (token.params) {
    ...
    langName = escapeHtml2(replaceEntities(unescapeMd(fenceName)));
    langClass = ' class="' + langPrefix + langName + '"';
  }
  if (options.highlight) {
    highlighted = options.highlight.apply(options.highlight, [token.content].concat(fences2)) || escapeHtml2(token.content);
  } else {
...
rules.link_open = function(tokens, idx, options) {
  var title = tokens[idx].title ? ' title="' + escapeHtml2(replaceEntities(tokens[idx].title)) + '"' : "";
  var target = options.linkTarget ? ' target="' + options.linkTarget + '"' : "";
  return '<a href="' + escapeHtml2(tokens[idx].href) + '"' + title + target + ">";
};
rules.link_close = function() {
  return "</a>";
};
rules.image = function(tokens, idx, options) {
  var src = ' src="' + escapeHtml2(tokens[idx].src) + '"';
  var title = tokens[idx].title ? ' title="' + escapeHtml2(replaceEntities(tokens[idx].title)) + '"' : "";
  var alt = ' alt="' + (tokens[idx].alt ? escapeHtml2(replaceEntities(unescapeMd(tokens[idx].alt))) : "") + '"';
...
rules.sub = function(tokens, idx) {
  return "<sub>" + escapeHtml2(tokens[idx].content) + "</sub>";
};
rules.sup = function(tokens, idx) {
  return "<sup>" + escapeHtml2(tokens[idx].content) + "</sup>";
};
...
rules.abbr_open = function(tokens, idx) {
  return '<abbr title="' + escapeHtml2(replaceEntities(tokens[idx].title)) + '">';
};
...
// node_modules/markmap-lib/dist/index.esm.js
var import_remarkable_katex = __toESM(require_remarkable_katex());
...
var BASE_JS = [`https://cdn.jsdelivr.net/npm/d3@${"6.7.0"}`, `https://cdn.jsdelivr.net/npm/markmap-view@${"0.13.4"}`].map((src) => ({
  type: "script",
  data: {
    src
  }
  ...
  transformHooks.parser.tap((md) => {
    md.set({
      highlight: (str2, lang) => {
        ...
        if (!grammar && lang) {
          (0, import_components.default)([lang]);
          grammar = import_prismjs.default.languages[lang];
        }
        if (grammar) {
          return import_prismjs.default.highlight(str2, grammar, lang);
        }
        return "";
      }
    });
...
markmap-common/dist/index.esm.js:
  (*! markmap-common v0.13.4 | MIT License *)

js-yaml/dist/js-yaml.mjs:
  (*! js-yaml 4.1.1 https://github.com/nodeca/js-yaml @license MIT *)

markmap-lib/dist/index.esm.js:
